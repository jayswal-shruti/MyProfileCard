...
package com.codingtroops.myprofilecard2
...
val userProfileList = arrayListOf<UserProfile>(
    UserProfile(name = "johny ",status = true ,R.drawable.image),
    UserProfile(name = "Sins ",status = false ,R.drawable.image),
    UserProfile(name = "johny ",status = true ,R.drawable.image),
    UserProfile(name = "johny ",status = true ,R.drawable.image),
    UserProfile(name = "johny ",status = true ,R.drawable.image),
    UserProfile(name = "johny ",status = true ,R.drawable.image),
...
val userProfileList = arrayListOf(
    ...
    UserProfile(
        id =8,name = "Georgia S.", status = false,
