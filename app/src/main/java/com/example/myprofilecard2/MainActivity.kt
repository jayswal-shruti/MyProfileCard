package com.example.myprofilecard2
...
import com.codingtroops.myprofilecard2.UserProfile
import com.codingtroops.myprofilecard2.userProfileList
import com.example.myprofilecard2.ui.theme.LightGreen
import com.example.myprofilecard2.ui.theme.MyTheme
...
fun UsersApplication(userProfiles:List<UserProfile> = userProfileList ){
    ...
    NavHost(navController = navController, startDestination = "users_list"){
        composable("users_list"){
            UserListScreen(userProfiles,rememberNavController())
        }
        composable(
...
@Composable
fun ProfilePicture( pictureUrl:String, onlineStatus: Boolean , imageSize:Dp){ //drawable:Int
    Card(
    shape = CircleShape ,
    border = BorderStroke(
        width = 2.dp ,
